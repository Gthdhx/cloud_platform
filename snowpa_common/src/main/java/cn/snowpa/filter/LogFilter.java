...
import cn.snowpa.utils.DateUtils;
...
public class LogFilter {
    ...
    @Pointcut("execution(* cn.snowpa.mapper..*(..))")
    public void mapper() {
    }
    ...
    @AfterReturning(pointcut = "mapper()", returning = "returnValue")
    ...
    @AfterThrowing(pointcut = "mapper()", throwing = "e")
